...
m0, mean0, med0, dat, lag = mkplt(spreadb[['cf0','cf1','cf2','cf3','cf4','cf5']],1,3,1,r'% authors','bo',True,1)
m1, mean1, med1, dat, lag = mkplt(spreadr[['cf0','cf1','cf2','cf3','cf4','cf5']],1,3,1,r'% authors','r',True,1)
m2, mean2, med2, dat, lag = mkplt(spreads[['cf0','cf1','cf2','cf3','cf4','cf5']],1,3,1,r'% authors','y',True,1)
m3, mean3, med3, dat, lag = mkplt(spreadl[['cff','cf0','cf1','cf2','cf3','cf4']],1,3,1,r'% authors','g',True,1)
lgd = plt.legend([mean0[0], mean1[0], mean2[0], mean3[0], dat[0]], ['bench', 'nation', 'field_dep', 'pub lag', 'data'], 4)
#plt.savefig('sim_plots_cf_cf.png',bbox_inches=0)

# fig5 = plt.figure(figsize=(17,  8),  dpi=80)
m0, mean0, med0, dat, lag = mkplt(spreadb[['df0','df1','df2','df3','df4','df5']],1,3,2,r'% departments','bo',True,2)
m1, mean1, med1, dat, lag = mkplt(spreadr[['df0','df1','df2','df3','df4','df5']],1,3,2,r'% departments','r',True,2)
m2, mean2, med2, dat, lag = mkplt(spreads[['df0','df1','df2','df3','df4','df5']],1,3,2,r'% departments','y',True,2)
m3, mean3, med3, dat, lag = mkplt(spreadl[['dff','df0','df1','df2','df3','df4']],1,3,2,r'% departments','g',True,2)
lgd = plt.legend([mean0[0], mean1[0], mean2[0], mean3[0], dat[0]], ['bench', 'nation', 'field_dep', 'pub lag', 'data'], 4)
...
m0, mean0, med0, dat, lag = mkplt(spreadb[['sd0','sd1','sd2','sd3','sd4','sd5']],1,3,3,r'department coef of var','bo',True,3)
m1, mean1, med1, dat, lag = mkplt(spreadr[['sd0','sd1','sd2','sd3','sd4','sd5']],1,3,3,r'department coef of var','r',True,3)
m2, mean2, med2, dat, lag = mkplt(spreads[['sd0','sd1','sd2','sd3','sd4','sd5']],1,3,3,r'department coef of var','y',True,3)
m3, mean3, med3, dat, lag = mkplt(spreadl[['sdf','sd0','sd1','sd2','sd3','sd4']],1,3,3,r'department coef of var','g',True,3)
lgd = plt.legend([mean0[0], mean1[0], mean2[0], mean3[0], dat[0]], ['bench', 'nation', 'field_dep', 'pub lag', 'data'], 1)
plt.savefig('sim_plots_mc.png',bbox_inches=0)

fig2 = plt.figure(figsize=(17,  8),  dpi=80)
m0, mean0, med0, dat, lag = mkplt(spreadb[['cf0','cf1','cf2','cf3','cf4','cf5']],1,1,1,r'% authors','bo',True,1)
m1, mean1, med1, dat, lag = mkplt(spreadr[['cf0','cf1','cf2','cf3','cf4','cf5']],1,1,1,r'% authors','r',True,1)
m2, mean2, med2, dat, lag = mkplt(spreads[['cf0','cf1','cf2','cf3','cf4','cf5']],1,1,1,r'% authors','y',True,1)
m3, mean3, med3, dat, lag = mkplt(spreadl[['cff','cf0','cf1','cf2','cf3','cf4']],1,1,1,r'% authors','g',True,1)
lgd = plt.legend([mean0[0], mean1[0], mean2[0], mean3[0], dat[0]], ['bench', 'nation', 'field_dep', 'pub lag', 'data'], 4)
plt.savefig('sim_plots_mc_single.png',bbox_inches=0)
