...
if __name__ == '__main__':
    ...
    mkplt(p[' gam1'],               5, 3, 8, 'gam1', 0)
    mkplt(p[' field_co'],           5, 3, 9, 'field_co'  , 0)
    mkplt(p[' qual_co'],            5, 3, 10, 'qual_co'   , 0)
    mkplt(p[' lat_co'],             5, 3, 11, 'lat_co'    , 0)
    mkplt(p[' lo'],                 5, 3, 12, 'lo1'       , 0)
    mkplt(p[' ip'],                 5, 3, 13, 'ip'        , 0)
    mkplt(p[' lat_prob1'][::8],     5, 3, 14, 'lat_prob1' , 0)
    mkplt(p[' lat_prob2'][::8],     5, 3, 15, 'lat_prob2' , 0)
