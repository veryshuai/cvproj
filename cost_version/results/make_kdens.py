...
mkplt(params['alp0']         ,2,7,1,r'base learn $\alpha$'       ,0,False)
mkplt(params[' alp1']       ,2,7,2,r'Time learn'       ,0,False)
mkplt(params[' bet']        ,2,7,4,r'depend learn $\beta$'     ,0,False)
mkplt(params[' gam0']       ,2,7,3,r'interest prob $\gamma_{NF}$'      ,0,False)
mkplt(params[' gam1']       ,2,7,5,r'interest prob $\gamma_{F}$'    ,0,False)
mkplt(params[' field_co']   ,2,7,6,r'field wage $\xi_f$'  ,0,False)
mkplt(params[' lat_co']     ,2,7,7,r'lat wage $\xi_l$'    ,0,False)
mkplt(params[' qual_co']    ,2,7,8,r'qual wage $\xi_q$'   ,0,False)
mkplt(params[' lo']         ,2,7,9,r'move cost C',0,False)
# mkplt(params[' lat_prob1'],3,4,9,r'init_cond base'   ,0,False)
mkplt(params[' lat_prob1']  ,2,7,10, r'init_cond $\phi_Q$'   ,0,False)
mkplt(params[' lat_prob2']  ,2,7,11, r'init_cond $\phi_F$'   ,0,False)
mkplt(params[' lat_prob3']  ,2,7,12,r'lat disp $\sigma$'   ,0,False)
mkplt(params[' ip']         ,2,7,13,r'log exog $\xi_{ex}$'     ,0,False)
