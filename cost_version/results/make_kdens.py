...
mkplt(params['alp0']        ,3,5,1,r'base learn $\alpha$'       ,0,False)
mkplt(params[' alp1']       ,3,5,2,r'Year learn'       ,0,False)
mkplt(params[' alp2']       ,3,5,3,r'Year learn square'       ,0,False)
mkplt(params[' alp3']       ,3,5,4,r'Duration in sample'       ,0,False)
mkplt(params[' alp4']       ,3,5,5,r'Duration in sample square'       ,0,False)
mkplt(params[' bet']        ,3,5,6,r'depend learn $\beta$'     ,0,False)
mkplt(params[' gam0']       ,3,5,7,r'field learn $\gamma$'    ,0,False)
mkplt(params[' field_co']   ,3,5,8,r'field wage $\xi_f$'  ,0,False)
mkplt(params[' lat_co']     ,3,5,9,r'lat wage $\xi_l$'    ,0,False)
mkplt(params[' qual_co']    ,3,5,10,r'qual wage $\xi_q$'   ,0,False)
mkplt(params[' lo']         ,3,5,11,r'move cost C',0,False)
# mkplt(params[' lat_prob1'],3,5,9,r'init_cond base'   ,0,False)
mkplt(params[' lat_prob1']  ,3,5,12, r'init_cond $\phi_F$'   ,0,False)
mkplt(params[' lat_prob2']  ,3,5,13,r'lat disp $\sigma$'   ,0,False)
mkplt(params[' ip']         ,3,5,14,r'log exog $\xi_{ex}$'     ,0,False)
plt.savefig('params_dists_big.png',bbox_inches=0)
# fig2 = plt.figure(
