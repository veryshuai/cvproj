#0 This file runs the large estimation loop,
...
def update_cits(cit_params, rnd):
    ...
    try:
        ...
        print e
        s_alp0, s_alp1, s_bet0, s_bet1, s_gam0, s_gam1\
                = 1, 1, 1, 1, 1, 1

    [alp, gam, bet] = cit_params
    alp[0] = alp[0] + random.gauss(0,rnd['alpha0'] * s_alp0)
    alp[1] = alp[1] + random.gauss(0,rnd['alpha1'] * s_alp1)
