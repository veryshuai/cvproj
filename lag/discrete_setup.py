...
cit_times_df['cit_times'] = cit_times_df['cit_times'] - 1
cit_times_df['cit_times'] = cit_times_df['cit_times'].apply(lambda x: max(x, 1987))
...
combined['start_times'][pd.notnull(combined['cit_times'])] = combined_nonulls['start_times'] - 1
combined['start_times'][pd.notnull(combined['cit_times'])] = combined_nonulls['start_times'] - 1
