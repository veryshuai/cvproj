...
mkplt(params[' field_co']   ,3,4,5,r'field wage'  ,0,False)
mkplt(params[' lat_co']     ,3,4,6,r'latent type wage'    ,0,False)
mkplt(params[' qual_co']    ,3,4,7,r'qual wage'   ,0,False)
mkplt(params[' lo']         ,3,4,8,r'offer arrival'     ,0,False)
mkplt(params[' lat_prob1']  ,3,4,9,r'init_cond base'   ,0,False)
mkplt(params[' lat_prob2']  ,3,4,10,r'init_cond depend'   ,0,False)
mkplt(params[' lat_prob3']  ,3,4,11,r'latent type  disp'   ,0,False)
mkplt(params[' ip']         ,3,4,12,r'log exog var param'     ,0,False)
