...
mkplt(p[' bet_q0_f0_l0'], 3, 2, 3, 'bet_q0_f0_l0', 0)
mkplt(p[' bet_q0_f1_l0'], 3, 2, 6, 'bet_q0_f1_l0', 0)
mkplt(p['alp_q0_f0_l0'],  3, 2, 1, 'alp_q0_f0_l0', 0)
mkplt(p[' alp_q0_f1_l0'], 3, 2, 4, 'alp_q0_f1_l0', 0)
mkplt(p[' gam_q0_f0_l0'], 3, 2, 2, 'gam_q0_f0_l0', 0)
mkplt(p[' gam_q0_f1_l0'], 3, 2, 5, 'gam_q0_f1_l0', 0)
