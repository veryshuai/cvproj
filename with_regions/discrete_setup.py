...
# PIVOT KNOW FRACTIONS
dep_reg = aut_pan[['shift_reg','date','rfrac']].drop_duplicates(cols=['reg','date'])
dep_reg.columns = ['reg','date','kfrac']
...
# CLEAN UP AUTPAN
aut_pan           = aut_pan[['au', 'date', 'dep', 'reg', 'dmean',
                             'qual', 'dep_qual', 'kfrac', 'rfrac', 'isField',
