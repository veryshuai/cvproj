...
params[' ip'] = params[' ip'].apply(math.log)
...
mkplt(params['alp0']        ,3,5,1,r'base param $\alpha_{NF}$'       ,0,False)
mkplt(params[' alp1']       ,3,5,2,r'base param $\alpha_{F}$'        ,0,False)
mkplt(params[' gam0']       ,3,5,3,r'interest prob $\gamma_{NF}$'    ,0,False)
mkplt(params[' gam1']       ,3,5,4,r'interest prob $\gamma_{F}$'     ,0,False)
mkplt(params[' bet0']       ,3,5,5,r'depend param $\beta_{NF}$'     ,0,False)
mkplt(params[' bet1']       ,3,5,6,r'depend param $\beta_{F}$'      ,0,False)
mkplt(params[' field_co']   ,3,5,7,r'field wage $\xi_f$'  ,0,False)
mkplt(params[' lat_co']     ,3,5,8,r'lat wage $\xi_l$'  ,0,False)
mkplt(params[' qual_co']    ,3,5,9,r'qual wage $\xi_q$' ,0,False)
mkplt(params[' lo']         ,3,5,10,r'offer arrival $\lambda_o$'     ,0,False)
mkplt(params[' lat_prob2']  ,3,5,11,r'init_cond $\phi_F$'  ,0,False)
mkplt(params[' lat_prob3']  ,3,5,12,r'lat disp $\sigma$'   ,0,False)
mkplt(params[' ip']         ,3,5,13,r'log exog $\xi_{ex}$' ,0,False)
